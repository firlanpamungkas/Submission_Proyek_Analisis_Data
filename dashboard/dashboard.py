...
bike_day_csv_path = os.path.join(script_dir, 'day_data.csv')
bike_hour_csv_path = os.path.join(script_dir, 'hour_data.csv')
rfm_csv_path = os.path.join(script_dir, 'rfm_data.csv')
